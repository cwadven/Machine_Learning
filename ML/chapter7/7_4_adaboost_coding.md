...
# ensemble AdaBoost 이용할 것 import
...
# AdaBoost은 여러개의 tree 모델을 만들 때, 자기가 스스로
...
# 반복문을 이용해서 검증하기
# 원래는 AdaBoost만 해주면 되는데, 얼마나 정확한지 알기 위해서
...
<img src="https://github.com/cwadven/Machine_Learning/blob/master/ML/chapter7/img/seq8.PNG" alt="drawing" width="500"/><br><br>